my_file = open("data/corpus/cardo.txt", "w+") # создает документ для вывода текста

filenames = [i for i in 'data/cardo']
'''
filenames = ['1.txt', '2.txt', '3.txt', '4.txt', '5.txt', '6.txt', '7.txt', '8.txt', '9.txt', '10.txt',
             ...
             '41.txt', '42.txt', '43.txt', '44.txt', '45.txt', '46.txt', '47.txt', '48.txt']
'''
with open('data/corpus/cardo.txt', 'w') as outfile:
